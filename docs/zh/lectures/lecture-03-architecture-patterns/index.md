...
description: 以你在 P02 实现的 RSSM 为基线，横向比较六大世界模型架构族，掌握三种学习范式的知识边界，以及 CEM-MPC、潜在 Actor-Critic 与 TD-MPC 三种规划机制的原理与取舍。
lecture: 3
difficulty: 中高
---
...
- **Part A · 架构模式**：六大架构族（RNN/RSSM、Transformer、Diffusion、JEPA、RWM、WAM）的原理对比与选型指南，以及三种学习范式的知识边界
