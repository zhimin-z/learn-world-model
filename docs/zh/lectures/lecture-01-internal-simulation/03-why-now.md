...
<figure>
<img src="/gaia/gaia-schematic.png" alt="GAIA-1：自动驾驶生成世界模型，视频、文本与动作联合建模" style="width:100%;display:block;margin:0 auto">
<figcaption>Hu et al. (2023) GAIA-1 的架构示意：以历史视频帧序列、自然语言描述和动作信号为联合输入，通过生成式世界模型预测未来视频帧，实现对驾驶场景的可控仿真。GAIA-1 展示了"视频生成能力可以直接服务于自动驾驶反事实测试"的可行性，是自动驾驶与生成式世界模型交汇的早期代表。</figcaption>
</figure>
