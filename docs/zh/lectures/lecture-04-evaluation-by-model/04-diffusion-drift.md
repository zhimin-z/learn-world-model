...
<figure>
<img src="/diamond/diamond-drift.png" alt="Diamond 扩散世界模型的时程漂移：生成帧质量随展开步数的衰减" style="width:100%;display:block;margin:0 auto">
<figcaption>Alonso et al. (2024) Diamond 的漂移诊断图：随着自回归展开步数增加（横轴），生成帧与真实帧的差异（纵轴）系统性累积。扩散模型的每帧独立去噪特性使物体身份、位置和遮挡关系随步数逐渐失真，这是扩散世界模型区别于 RSSM 和 Transformer 的特有漂移模式。</figcaption>
</figure>
