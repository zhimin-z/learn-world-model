...
- **Dreamer** [见 L01 参考文献 [3]]：吃动作，预测潜在状态，狭义世界模型，主动决策者
- **STORM** [见 L03 参考文献 [1]]：不吃动作，预测视频帧（Transformer 主干），观察者
...
LeCun 提出的 JEPA（Joint Embedding Predictive Architecture）[2] 走了一条不同的方向。
